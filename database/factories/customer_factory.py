...
class CustomerFactory(Factory):
    ...
    def definition(self) -> dict:
        return {
            ...
            "organization": self.faker.random_element(elements=("Trisha Library", "G2 Library")),
            "sub_organization": self.faker.random_element(elements=("Premium Zone", "General Area", "Reading Room"))
        }
